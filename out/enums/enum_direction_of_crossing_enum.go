...
const (
	// A trigger condition is met when the metric value crosses the trigger value while increasing.
	DirectionOfCrossingEnum_INCREASING DirectionOfCrossingEnum = "Increasing"

	// A trigger is met when the metric value crosses the trigger value while decreasing.
