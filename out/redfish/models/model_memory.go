...
// Memory - The Memory schema represents a memory device, such as a DIMM, and its configuration.
// Modeled after DMTF Redfish schema Memory
type Memory struct {
	...
	AllowedSpeedsMHz []i `json:"AllowedSpeedsMHz,omitempty"`
	...
	FunctionClasses []s `json:"FunctionClasses,omitempty"`
	...
	MaxTDPMilliWatts []i `json:"MaxTDPMilliWatts,omitempty"`
