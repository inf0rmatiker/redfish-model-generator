/* -----------------------------------------------------------------
* file_system_collection.go -
*
* SNIA Swordfish FileSystemCollection resource defined as a Golang model
*
...
// Modeled after SNIA Swordfish schema FileSystemCollection
type FileSystemCollection struct {
	...
	Members []FileSystem `json:"Members"`
