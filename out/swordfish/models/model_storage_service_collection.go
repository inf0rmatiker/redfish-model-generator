/* -----------------------------------------------------------------
* storage_service_collection.go -
*
* SNIA Swordfish StorageServiceCollection resource defined as a Golang model
*
...
// Modeled after SNIA Swordfish schema StorageServiceCollection
type StorageServiceCollection struct {
	...
	Members []StorageService `json:"Members"`
